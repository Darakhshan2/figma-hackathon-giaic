  ...
  return (
    <>
      ...
      <div className="flex justify-center h-auto w-auto lg:w-[721px] lg:h-[759px] mb-8 lg:mb-0">
        <Image src="/Image Left.png" alt="The Dandy Chair" height={759} width={721} />
      </div>
      <div className="lg:pt-12 lg:pl-14 space-y-4 px-4 sm:px-8 lg:px-0">
        <h1 className="text-2xl sm:text-3xl lg:text-4xl">The Dandy Chair</h1>
        <p className="text-lg sm:text-xl">£250</p>
        ...
        <div className="pt-[30px] space-y-7 gap-[16px]">
          ...
          <div className="space-x-12 pt-2">
            ...
            <table className="min-w-full table-auto mt-8 border-collapse">
              <thead>
